...
from multitask_nlp.datasets.klej.polemo import KlejPolemoDataModule
...
if __name__ == "__main__":
    datamodule_cls = KlejPolemoDataModule
    ...
    domain_inside = True
    if domain_inside:
        wandb_project_name = 'PolEmo_IN_exp_test'
    else:
        wandb_project_name = 'PolEmo_OUT_exp_test'
