...
from multitask_nlp.datasets.klej.allegro_reviews import AllegroReviewsDataModule
from multitask_nlp.datasets.klej.cbd import CBD_DataModule
from multitask_nlp.datasets.klej.cdsc_e import CDSC_E_DataModule
from multitask_nlp.datasets.klej.cdsc_r import CDSC_R_DataModule
from multitask_nlp.datasets.klej.dyk import DYK_DataModule
from multitask_nlp.datasets.klej.nkjp_ner import NKJP_NER_DataModule
from multitask_nlp.datasets.klej.psc import PSC_DataModule
...
use_cuda = True
wandb_project_name = 'MTL_PL_KLEJ_w_FT2'
...
def run_experiments():
    ...
    task_datamodules_setup = {
        MultiemoDataModule: {"domain": "all", "language": "pl", "batch_size": batch_size},
        AllegroReviewsDataModule: {"batch_size": batch_size},
        CBD_DataModule: {"batch_size": batch_size},
        CDSC_E_DataModule: {"batch_size": batch_size},
        CDSC_R_DataModule: {"batch_size": batch_size, "normalize": True},
        DYK_DataModule: {"batch_size": batch_size},
        NKJP_NER_DataModule: {"batch_size": batch_size},
        PSC_DataModule: {"batch_size": batch_size},
    }
