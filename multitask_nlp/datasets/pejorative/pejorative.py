...
from multitask_nlp.settings import PEJORATIVE_DATA

DEFAULT_SPLITS = [0.6, 0.2, 0.2]


class PejorativeDataModule(BaseDataModule):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        self.data_dir = PEJORATIVE_DATA
        self.split_sizes = split_sizes
        self.annotation_column = ['is_pejorative']
